...
module lab7_soc_mm_interconnect_0 (
	...
	wire   [28:0] push_s1_agent_m0_address;                                                           // push_s1_agent:m0_address -> push_s1_translator:uav_address
	...
	wire  [105:0] push_s1_agent_rf_source_data;                                                       // push_s1_agent:rf_source_data -> push_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] push_s1_agent_rsp_fifo_out_data;                                                    // push_s1_agent_rsp_fifo:out_data -> push_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> push_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // push_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> push_s1_agent:cp_channel
	...
	wire  [104:0] push_s1_agent_rp_data;                                                              // push_s1_agent:rp_data -> router_008:sink_data
